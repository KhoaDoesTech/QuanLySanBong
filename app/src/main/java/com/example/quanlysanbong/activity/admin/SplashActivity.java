...
public class SplashActivity extends AppCompatActivity {
    ...
    String textAdmin3 = "Bạn sẽ tiết kiệm được thời gian quản lý nếu dùng Soccer Management";
    ...
    String textUser = "Bạn sẽ tiết kiệm thời gian đặt sân với Soccer Management.";
